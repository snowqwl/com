...
public class VideoDaoImpl extends BaseDaoImpl implements VideoDao {
	...
	public List<Map<String,Object>> getCameraTreeAsync(String id)throws Exception{
		...
		if("0".equals(id)){
			...
			sql = " select rescode as id,resname as idname,substr(rescode,0,4)||'00' as pid from JM_CAMERA where rescode like '%"+id.substring(0,4)+"%'";
		}
	...
	public boolean getCountFromCamera(String id)throws Exception{
		String sql = " select count(1) from jm_camera where rescode like '%"+id.substring(0, 4)+"%'";
