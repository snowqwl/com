package com.sunshine.monitor.comm.util.excel;
...
public abstract class OutputExcelUtils{
	 ...
	 * 导出模板文件
	 */
	public static String modelFile = "config/passrecModle.xls";
	...
	public static InputStream loadStream(String path){
		...
		try {
			input = OutputExcelUtils.class.getResourceAsStream(path);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return input;
