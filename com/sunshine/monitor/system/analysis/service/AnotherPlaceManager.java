...
public interface AnotherPlaceManager {
	  //根据指定条件查询外地号牌的车辆信息列表
	...
	public Map queryDangerousDetailList(String xh ,Map<String ,Object> filter,String sign) throws Exception;
	//查询不同过车类型的号牌总计数据分页（高危地区）
	public Map queryDangerousDetailList(Map<String ,Object> filter) throws Exception;
	//根据好牌号码查询过车轨迹
