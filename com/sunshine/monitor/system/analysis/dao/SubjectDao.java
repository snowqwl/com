...
public interface SubjectDao extends BaseDao {
	 ...
	 * @return
	 */
	public int[] saveContrail(List<Map<String,Object>> list,String ztbh)throws Exception;
	...
	/**
	 * 查询已保存分析数据同行轨迹信息，返回map
	 * @param ztbh
	 * @param filter
	 * @return
	 * @throws Exception
	 */
	public Map<String,Object> getPeerContrailForMap(String ztbh,ScsVehPassrec veh,Map<String,Object> filter)throws Exception;
	 ...
	 * @throws Exception
	 */
	public int[] saveLinkInfo(String ztbh,List<Map<String,Object>> list)throws Exception;
	 ...
	 * @throws Exception
	 */
	public int[] savecaseTouchInfo(String ztbh,List<Map<String,Object>> list)throws Exception;
