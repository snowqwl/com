...
@Transactional
@Service("alarmrecQueueProducerManager")
public class AlarmrecQueueProducerManagerImpl implements
	AlarmrecQueueProducerManager {

	@Autowired
    private JmsTemplate jmsTemplate;
	//@Autowired
	private Destination alarmrecQueueDestination;
	@Autowired
	private TransDao transDao;
	
	public void send(AlarmrecMessage message) throws Exception {
		this.jmsTemplate.convertAndSend(this.alarmrecQueueDestination, message);
	}
